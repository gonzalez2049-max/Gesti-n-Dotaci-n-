...
export const db = {
  ...
  planner: {
    ...
    personas: [
      { id: "f1", nombre: "Ana González", iniciales: "AG", estamento: "Enfermero/a", unidad: "UCI", equipo: "Equipo A", patronOffset: 0, habilitado: true, lider: true },
      { id: "f2", nombre: "Carla Muñoz", iniciales: "CM", estamento: "Enfermero/a", unidad: "UCI", equipo: "Equipo A", patronOffset: 1, habilitado: true },
      { id: "f3", nombre: "Diego Pérez", iniciales: "DP", estamento: "Enfermero/a", unidad: "UCI", equipo: "Equipo B", patronOffset: 2, habilitado: true, lider: true },
      ...
      { id: "f14", nombre: "Marta Núñez", iniciales: "MN", estamento: "Auxiliar", unidad: "UCI", equipo: "Equipo A", patronOffset: 0, habilitado: true },
      { id: "f15", nombre: "Pedro Lagos", iniciales: "PL", estamento: "Auxiliar", unidad: "UCI", equipo: "Equipo B", patronOffset: 2, habilitado: true },
